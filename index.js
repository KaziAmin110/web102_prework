...
const amountRaised = GAMES_JSON.reduce((sum, game) => {
...
// create a string that explains the number of unfunded games using the ternary operator
    const displayStr = `Currently, ${unfunded == 1? unfunded + " game" : unfunded + " games"} remain unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
    const paragraphElement = document.createElement('p');
    paragraphElement.innerText = displayStr;
...
let firstGame, secondGame, rest;
[firstGame, secondGame, ...rest] = sortedGames;
// create a new element to hold the name of the top pledge game, then append it to the correct element
const divFirst = document.createElement('div');
const divSecond = document.createElement('div');

divFirst.innerText = firstGame.name;
divSecond.innerText = secondGame.name;
